...
class ToggleLikeUseCase @Inject constructor(
    ...
    suspend operator fun invoke(postId: String, authorId: String, isAlreadyLiked: Boolean, title: String): Result<Unit> {
        ...
        return repository.toggleLike(postId, user.uid, isAlreadyLiked, title)
    }
}
