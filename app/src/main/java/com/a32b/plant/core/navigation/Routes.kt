...
sealed interface Routes {
    ...
    @Serializable data class CommunityPost(val postId: String? = null, val potId: String? = null, val tagId: String, val tagName: String, val title: String? = null, val studyLogIds: List<String>? = emptyList()) : Routes
