...
sealed interface Routes {
    ...
    @Serializable data class CommunityPost(val postId: String? = null, val potId: String? = null, val tag: String? = null, val title: String? = null, val studyLogIds: List<String>? = emptyList()) : Routes
